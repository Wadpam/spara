...
/**
 * Implementation of Business Methods related to entity DCommit.
 ...
 */
public class DCommitDaoBean 
	extends GeneratedDCommitDaoImpl
{

  @Inject
  public DCommitDaoBean(Supplier supplier) {
    super(supplier);
  }
